...
public class RedBullCrabModel extends EntityModel<RedBullCrabRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(FinsAndTails.id("red_bull_crab"), "main");
    ...
    @Override
    public void setupAnim(RedBullCrabRenderState state) {
