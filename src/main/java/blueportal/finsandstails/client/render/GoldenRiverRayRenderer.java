...
public class GoldenRiverRayRenderer extends MobRenderer<GoldenRiverRayEntity, GoldenRiverRayRenderState, GoldenRiverRayModel> {
    ...
    @Override
    public GoldenRiverRayRenderState createRenderState() {
        return new GoldenRiverRayRenderState();
    }

    @Override
    public void extractRenderState(GoldenRiverRayEntity entity, GoldenRiverRayRenderState state, float partialTicks) {
